...
#      new_refinement_flags = self.refinement_flags.select(selection)
  ...
  def show_groups(self, rigid_body = None, tls = None, nm = None,
    ...
    if(nm is not None): selections = self.refinement_flags.adp_nm
    if(self.refinement_flags.sites_rigid_body is None and
                                 self.refinement_flags.adp_tls is None and
                                 self.refinement_flags.adp_nm): return
